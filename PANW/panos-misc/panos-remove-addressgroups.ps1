...
$uri = "https://$firewallIp/restapi/v11.0/Objects/AddressGroups?location=vsys&vsys=vsys1"

# Make a GET request to retrieve the address objects
(Invoke-RestMethod -Uri $uri -Method "GET" -Headers $Headers  -UseBasicParsing).Result.entry | ForEach-Object {
    $name = $_.'@name'
    $uri = "https://$firewallIp/restapi/v11.0/Objects/AddressGroups?location=vsys&vsys=vsys1&name=$name"
